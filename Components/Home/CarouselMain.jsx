        ...
        <Box height="100vh">
          ...
          <Container>
            ...
            >
              ...
              <Typography variant="h2" component={motion.li} variants={item}>
                Blancpain Villeret
              </Typography>
              <Typography variant="p" component={motion.li} variants={item}>
                This elegant day-date from Villeret collection was introduced at
                Baselworld 2017.
              </Typography>
              <Stack
                direction="row"
              ...
              <Box component={motion.li} variants={item}>
                <ButtonBorder sx={{ py: "10px" }}>Shopping Now</ButtonBorder>
              </Box>
            </Stack>
          </Container>
        </Box>
